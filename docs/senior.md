...
本赛题要求选⼿在 Ascend 910B3 硬件平台上，**使⽤ Triton-Ascend 或 TileLang-Ascend 语言**（二选一即可）编写一个<font color=red>**带 quest 的、支持 GQA 的 `Sparse Attention` 算子**</font>，代码框架可以在类脑平台的共享存储获得，具体位置如下图；题面在[此处](./assignment/sparse-1.pdf)。
